...
export default function Coordinator({ signedIn }: { signedIn: boolean }) {
  ...
  return <main className="coordinator">
    <header className="masthead"><div><span className="wordmark">HEY LINDSAY<span className="brand-period">.</span></span><p>Your on-hand coordinator.</p></div>
    ...
    <section className="voice-stage" aria-label="Voice conversation">
      ...
      <h1>Keep moving.<br/><span>I’m right here.</span></h1>
      <p className="intro">The plan. The details. The thing you almost forgot.<br className="desktop-break"/> Just ask Lindsay.</p>
